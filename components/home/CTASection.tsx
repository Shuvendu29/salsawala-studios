...
export function CTASection() {
  return (
    <section className="py-24 bg-dark relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_50%,rgba(196,30,58,0.12),transparent)]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="font-body text-lg text-white/60 mb-8 max-w-xl mx-auto leading-relaxed">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10 max-w-xl mx-auto text-left">
          {perks.map(perk => (
            <li key={perk} className="flex items-start gap-2.5">
              ...
              <span className="font-body text-sm text-white/70">{perk}</span>
            </li>
          ))}
        </ul>
